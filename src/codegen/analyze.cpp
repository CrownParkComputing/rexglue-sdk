...
// Lightweight wall-clock scope timer for analysis phases.
class PhaseTimer {
 public:
  ...
  ~PhaseTimer() {
    ...
    REXCODEGEN_INFO("Analyze: phase {} took {:.3f}s", name_, elapsed.count() / 1000.0);
  }
